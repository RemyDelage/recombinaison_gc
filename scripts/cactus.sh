...
out_dir="/home/genouest/cnrs_umr6553/rdelage/results/"
cactus_dir="02_cactus/"
...
singularity exec --bind "$data_dir":/mnt --bind "$out_dir" --pwd "$data_dir" cactus.sif cactus --consCores 16 "$jobStorePath" "$inputSeqFile" "$out_dir$outputHalFile"
