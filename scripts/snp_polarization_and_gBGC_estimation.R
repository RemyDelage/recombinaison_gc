...
snp_polarization <- function(species, chromosome_num){
  ...
  snp_counts_megred = read.table(paste0("snp_counts_merged_", species, "_chrom_", chromosome_num, ".tsv"), header = TRUE, sep = "\t")
...
gBGC_estimations <- function(data_mutation1, data_mutation2){
  ...
  cat(paste0("gBGC estimation chromosome : ", chromosome_num, "level : ", genomic_level, "\n"))
  return(gBGC)
}
