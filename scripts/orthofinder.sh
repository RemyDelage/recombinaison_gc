...
#SBATCH --mem=50G
#SBATCH --output=orthofinder_20240318.out
...
scripts_dir="/home/genouest/cnrs_umr6553/rdelage/scripts/01_orthofinder/"
...
for file in *faa ; do python "$scripts_dir"primary_transcript.py $f ; done
